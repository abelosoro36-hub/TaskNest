...
declare global { var _mongoConn4: { conn: typeof mongoose | null; promise: Promise<typeof mongoose> | null }; }
const cache = global._mongoConn4 ?? { conn: null, promise: null };
global._mongoConn4 = cache;
...
interface ITicket extends Document {
  user: mongoose.Types.ObjectId; subject: string; message: string;
  category: string; priority: string; status: string; agent: string;
  replies: { from: string; message: string; createdAt: Date }[];
}
